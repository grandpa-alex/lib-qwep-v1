...
import { TypeSSCheckbox } from '../../../general/styleScheme';
...
export declare const SubmitCheckbox: React.FC<SubmitCheckboxProps>;
export declare const SSubmitCheckbox: {
    Root: import('styled-components/dist/types').IStyledComponentBase<"web", import('styled-components/dist/types').Substitute<import('styled-components').FastOmit<Omit<import('@radix-ui/react-checkbox').CheckboxProps & React.RefAttributes<HTMLButtonElement>, "ref"> & {
    ...
    } & Omit<import('@radix-ui/react-checkbox').CheckboxProps & React.RefAttributes<HTMLButtonElement>, "ref"> & {
        ref?: ((instance: HTMLButtonElement | null) => void | React.DO_NOT_USE_OR_YOU_WILL_BE_FIRED_CALLBACK_REF_RETURN_VALUES[keyof React.DO_NOT_USE_OR_YOU_WILL_BE_FIRED_CALLBACK_REF_RETURN_VALUES]) | React.RefObject<HTMLButtonElement> | null | undefined;
    }, SRootProps>> & string;
    Icon: import('styled-components/dist/types').IStyledComponentBase<"web", import('styled-components/dist/types').Substitute<React.SVGProps<SVGSVGElement>, {
        $colorVariant: import('../../../types/TypeBase').TypeVariantColor;
        $colors: import('../../../general/colors').TypeColorScheme;
        $color?: import('../../../general/colors').Hex;
        $disabled?: boolean;
    } & React.SVGProps<SVGSVGElement>>> & string;
    Indicator: React.ForwardRefExoticComponent<import('@radix-ui/react-checkbox').CheckboxIndicatorProps & React.RefAttributes<HTMLSpanElement>>;
};
export declare namespace TSubmitCheckbox {
    type Main = SubmitCheckboxProps;
    type SRoot = SRootProps;
    type SIcon = TBaseCheckbox.SIcon;
    type Styles = TBaseCheckbox.Styles;
    type SIndicator = TBaseCheckbox.SIndicator;
}
export {};

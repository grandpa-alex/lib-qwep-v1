import { BaseBox, BasePopup, BaseSelectContent, BaseSelectGroup, BaseSelectItem, Icon, SimpleBox, SimpleButton, SimpleTextField, SubmitButton } from '@src/lib';
    ...
    return (
        <div style={{ paddingBottom: '300px' }}>
            ...
            <div style={{ display: 'flex' }}>
                ...
                <BaseSelectContent sizeVariant={'M'} colorVariant={'success'} mr={'m-3'} placeholder={'Successs select'}>
                    <BaseSelectItem value={'1'}>Item 1</BaseSelectItem>
                    <BaseSelectItem value={'2'}>Item 2</BaseSelectItem>
                    <BaseSelectItem value={'3'}>Item 3</BaseSelectItem>
                    <BaseSelectItem value={'4'}>Item 4</BaseSelectItem>
            ...
            <div style={{ display: 'flex' }}>
                ...
                <BaseSelectContent positionTrigger={'left'} colorVariant={'warning'} mr={'m-3'} width={'200px'} placeholder={'Warning select'}>
                    <BaseSelectGroup title={'Group 1'}>
                        <BaseSelectItem value={'1'}>Item 1</BaseSelectItem>
                        <BaseSelectItem value={'2'}>Item 2</BaseSelectItem>
                        <BaseSelectItem disabled value={'3'}>Item 3</BaseSelectItem>
                        <BaseSelectItem disabled value={'4'}>Item 4</BaseSelectItem>
                        <BaseSelectItem value={'5'}>Item 5</BaseSelectItem>
                    </BaseSelectGroup>
                    <BaseSelectGroup title={'Group 2'}>
                        <BaseSelectItem value={'6'}>Item 1</BaseSelectItem>
                ...
                <BaseSelectContent positionTrigger={'right'} colorVariant={'warning'} mr={'m-3'} width={'200px'} placeholder={'Warning select'}>
                    <BaseSelectGroup title={'Group 1'}>
                        <BaseSelectItem value={'1'}>Item 1</BaseSelectItem>
                        <BaseSelectItem value={'2'}>Item 2</BaseSelectItem>
                        <BaseSelectItem disabled value={'3'}>Item 3</BaseSelectItem>
            ...
            <h4>BASE SCROLL M COLORS</h4>
            <div style={{ display: 'flex' }}>
                <BaseSelectContent mr={'m-3'} positionTrigger={'left'} onValueChange={e => console.log(e)} width={'200px'} placeholder={'Default select'}>
                    <BaseSelectGroup title={'Group 1'}>
                        <BaseSelectItem value={'1'}>Item 1</BaseSelectItem>
                        <BaseSelectItem value={'2'}>Item 2</BaseSelectItem>
                        <BaseSelectItem value={'3'}>Item 3</BaseSelectItem>
            ...
            <div style={{ display: 'flex' }}>
                <BasePopup mr={'m-3'} popupComponent={
                    <SimpleBox 
                    boxGapVariant={'g-2'}
                    ...
                    >
                        ...
                        <SimpleTextField placeholder={'Placeholder'}/>
                        <SubmitButton icon={<Icon.Gear/>} isLoading={false}>Submit</SubmitButton>
                    </SimpleBox>
                }>
